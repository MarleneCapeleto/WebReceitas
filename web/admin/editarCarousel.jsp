<%-- 
    Document   : editarCarousel
    Created on : 5 de dez. de 2022, 20:36:54
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Gerenciar Carousel</li>
                        </ol>
                    </div>
                    <%
                        ...
                        try {
                            ...
                            rs = st.executeQuery("SELECT *FROM carousel WHERE id = '"+id+"' ");
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    <small>Formulário de atualização da Receita</small>
                                    <form action="config/editarCarousel.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
