<%-- 
    ...
    Created on : 2 de dez. de 2022, 20:16:41
...
<%
    ...
    if(up.formProcess(getServletContext(), request)) {
        ...
        try {
            ...
            st.executeUpdate("UPDATE carousel set nome = '"+nome+"', descricao = '"+desc+"', imagem= '"+imagem+"' WHERE id = '"+id+"' ");
 
            File file = new File("C:\\Users\\Marlene Capeletto\\Documents\\NetBeans\\WebReceitas\\web\\admin\\arquivos\\"+nameImg);
            file.delete();
 
            response.sendRedirect("../carousel.jsp?status=2"); //Atualizado com sucesso.
        } catch (Exception e) {
            out.print(e);
        }
