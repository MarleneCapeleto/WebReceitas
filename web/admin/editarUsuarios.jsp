<%-- 
    ...
    Created on : 7 de dez. de 2022, 00:19:25
                        ...
                        try {
                            ...
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    ...
                                    <form action="config/editarUsuarios.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Imagem da Usuario</label>
