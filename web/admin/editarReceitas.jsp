                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Gerenciar Receitas</li>
                        </ol>
                    </div>
                    <%
                        ...
                        try {
                            ...
                            rs = st.executeQuery("SELECT *FROM receitas WHERE id = '"+id+"' ");
                            while(rs.next()){ %>
                                <div class="container-fluid px-4">
                                    <small>Formulário de atualização da Receita</small>
                                    <form action="config/editarReceitas.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
